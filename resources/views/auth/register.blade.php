            ...
            <div class="col-md-6 offset-md-3">
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Enter Name" :value="old('name')" required autofocus>
                      </div>
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="password" name="password_confirmation" class="form-control" id="password"  required autocomplete="new-password">
                  </div>
                  <div class="mb-3">
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('login') }}">
